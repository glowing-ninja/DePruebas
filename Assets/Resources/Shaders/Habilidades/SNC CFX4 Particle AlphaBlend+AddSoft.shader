...
Shader "Sanctuary/Alpha Blended + Additive Soft (BaseColor)"
{
Properties
{
...
Category
{
	...
	SubShader
	{
		UsePass "Hidden/Sanctuary/Particles/ALPHA_BLENDED"
		UsePass "Hidden/Sanctuary/Particles/ADDITIVE_SOFT"
	}	
}
}
